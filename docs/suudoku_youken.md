...
| 画面名 | 目的 | 主要要素 | 遷移 |
|--------|------|----------|------|
| **Home** | ゲーム開始選択 | デイリー開始ボタン、通常Playボタン、言語/スクリプト切替 | デイリー開始→Play<br>通常Play→難易度/言語選択→Play |
| **Play** | メインプレイ | 9×9盤面、数字パッド、メモ機能、タイマー、ヒント表示 | クリア→Result<br>戻る→Home |
| **Result** | 結果表示 | クリアタイム、難易度、使用スクリプト | 完了→Home |
| **Settings** | 設定 | UI言語切替 | 保存→戻る |
